...
<body class="page-body">	
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="editActiveForm">
						...
						<div class="form-group" id="dname">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="name" name="name" value="<?php echo ($creative["name"]); ?>">
							</div>
						</div>
						<div class="form-group-separator"></div>
	...
	<script type="text/javascript" src="/efan/Public/Home/js/Creative/Admin/edit.js"></script>
