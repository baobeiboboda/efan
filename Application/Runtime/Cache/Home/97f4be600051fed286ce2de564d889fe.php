...
<body class="page-body">	
		...
		<div class="main-content">		
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">创意会创意申报</h3>
					
				</div>
				<div class="panel-body">
					
					<form role="form" class="form-horizontal" id="editActiveForm">
						...
						<div class="form-group" id="did" hidden>
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="id" name="id" value="<?php echo ($message["id"]); ?>">
							</div>
						</div>
						<div class="form-group" id="dtitle">
							<label class="col-sm-2 control-label" for="title">创意名称</label>
								
							<div class="col-sm-10">
								<input type="text" class="form-control" id="title" name="title" value="<?php echo ($creative["creativetitle"]); ?>">
							</div>
						</div>
						...
						<div class="form-group" id="dname">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="name" name="name" value="<?php echo ($creative["name"]); ?>" onblur="javascript:findUID()" _href="<?php $str = $Think.INDEX_PATH_NAME.$actions['CREATIVECLUBADMINEDITFINDUID']['url'];echo U($str,array('key'=>$actions['CREATIVECLUBADMINEDITFINDUID']['key']))?>">
							</div>
						</div>
						<div class="form-group-separator"></div>
						...
						<div class="form-group" id="dgroup">
								...
								<div class="col-sm-10">
									...
									<?php if(is_array($creativeGroup)): foreach($creativeGroup as $key=>$vo): if($vo["id"] == $creative['group']): ?><option value="<?php echo ($vo["id"]); ?>" selected><?php echo ($vo["group"]); ?></option>
										<?php else: ?>
											<option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["group"]); ?></option><?php endif; endforeach; endif; ?>
									</select>
								</div>
							</div>
						<div class="form-group-separator"></div>
						<div class="form-group" id="dcontent">
							<label class="col-sm-2 control-label" for="content">内容</label>
								
							<div class="col-sm-10">
								<script type="text/javascript" charset="utf-8" src="/Public/assets/ueditor/ueditor.config.js"></script>
						    	<script type="text/javascript" charset="utf-8" src="/Public/assets/ueditor/ueditor.all.min.js"> </script>
						    	<script type="text/javascript" charset="utf-8" src="/Public/assets/ueditor/lang/zh-cn/zh-cn.js"></script>
						    	<script id="content" name="content" type="text/plain" style="width:1024px;height:500px;"><?php echo ($creative["creative"]); ?></script>
							    <script>
									var ue = UE.getEditor('content');
							    </script>
							</div>
						</div>
						<?php if(isset($actions['CREATIVECLUBADMINEDITEDIT'])): ?><a type="button" id="btnsubmit" name="btnsubmit" class="btn btn-blue btn-single pull-right" _href='<?php $str = $Think.INDEX_PATH_NAME.$actions['CREATIVECLUBADMINEDITEDIT']['url'];echo U($str,array('key'=>$actions['CREATIVECLUBADMINEDITEDIT']['key']))?>'>提交</a><?php endif; ?>
	...
	<script type="text/javascript" src="/Public/Home/js/Creative/Admin/edit.js"></script>
