...
<body class="page-body">	
		...
		<div class="main-content">		
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="submitNoticeForm">
						<div class="form-group" id="dtoken" hidden>
							<label class="col-sm-2 control-label" for="token">token</label>
								
							<div class="col-sm-10">
								<input type="text" class="form-control" id="token" name="token" value="<?php echo ($notice["token"]); ?>">
							</div>
						</div>
						<div class="form-group" id="did" hidden>
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="id" name="id" value="<?php echo ($notice["id"]); ?>">
							</div>
						</div>
						<div class="form-group" id="dtitle">
							<label class="col-sm-2 control-label" for="title">通知标题</label>
								
							<div class="col-sm-10">
								<input type="text" class="form-control" id="title" name="title" placeholder="通知标题" value="<?php echo ($notice["title"]); ?>">
							</div>
						</div>
						<div class="form-group-separator"></div>
						<div class="form-group" id="dimportant">
							<label class="col-sm-2 control-label" for="important">标记重要</label>
								
							<div class="col-sm-10">
								<?php if($notice["important"] == 1): ?><input type="checkbox" name="important" id="important" value="1" checked="checked">重要
								<?php else: ?>
									<input type="checkbox" name="important" id="important" value="1">重要<?php endif; ?>
							</div>
						</div>
						<div class="form-group-separator"></div>
						<div class="form-group" id="dcontent">
							...
							<div class="col-sm-10">
						    	...
						    	<script id="content" name="content" type="text/plain" style="width:1024px;height:500px;"><?php echo ($notice["content"]); ?></script>
							    <script>
						...
						<?php if(isset($actions['WELCOMEINDEXNOTICEEDITSUBMIT'])): ?><a type="button" id="btnsubmit" name="btnsubmit" class="btn btn-blue btn-single pull-right" _href='<?php $str = $Think.INDEX_PATH_NAME.$actions['WELCOMEINDEXNOTICEEDITSUBMIT']['url'];echo U($str,array('key'=>$actions['WELCOMEINDEXNOTICEEDITSUBMIT']['key']))?>'>提交</a><?php endif; ?>
					</form>
	...
	<script type="text/javascript" src="/efan/Public/Home/js/Main/Notice/edit.js"></script>
