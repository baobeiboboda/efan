...
<body class="page-body">	
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="submitNoticeForm">
						...
						<div class="form-group" id="dtitle">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="title" name="title" placeholder="通知标题">
							</div>
						</div>
						...
						<div class="form-group" id="dimportant">
							...
							<div class="col-sm-10">
									<input type="checkbox" name="important" id="important" value="1">重要
							</div>
						</div>
						<div class="form-group-separator"></div>
						...
						<?php if(isset($actions['WELCOMEINDEXNOTICENEWSUBMIT'])): ?><a type="button" id="btnsubmit" name="btnsubmit" class="btn btn-blue btn-single pull-right" _href='<?php $str = $Think.INDEX_PATH_NAME.$actions['WELCOMEINDEXNOTICENEWSUBMIT']['url'];echo U($str,array('key'=>$actions['WELCOMEINDEXNOTICENEWSUBMIT']['key']))?>'>提交</a><?php endif; ?>
					</form>
	...
	<script type="text/javascript" src="/efan/Public/Home/js/Main/Notice/noticeNew.js"></script>
