...
<body class="page-body">	
		...
		<div class="main-content">		
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="submitActiveForm">
						...
						<div class="form-group" id="dtime" hidden>
							<label class="col-sm-2 control-label" for="time">time</label>
								
							<div class="col-sm-10">
								<input type="text" class="form-control" id="time" name="time" value="<?php echo ($message["time"]); ?>">
							</div>
						</div>
						<div class="form-group" id="dtitle">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="title" name="title" placeholder="创意名称">
							</div>
						</div>
						...
						<div class="form-group" id="dgroup">
								...
								<div class="col-sm-10">
									<select class="form-control" id="group" name="group">
										...
										<?php if(is_array($creativeGroup)): foreach($creativeGroup as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["group"]); ?></option><?php endforeach; endif; ?>
									</select>
								</div>
							</div>
						<div class="form-group-separator"></div>
						<div class="form-group" id="dname">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="name" name="name" placeholder="姓名" onblur="javascript:findUID()" _href="<?php $str = $Think.INDEX_PATH_NAME.$actions['CREATIVECLUBNEWFINDUID']['url'];echo U($str,array('key'=>$actions['CREATIVECLUBNEWFINDUID']['key']))?>">
							</div>
						</div>
						<div class="form-group-separator"></div>
						<div class="form-group" id="duid">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="uid" name="uid" value="自动获取" readonly="readonly">
							</div>
						</div>
						<div class="form-group-separator"></div>
						...
						<a type="button" id="btnsubmit" name="btnsubmit" class="btn btn-blue btn-single pull-right" _href='<?php $str = $Think.INDEX_PATH_NAME.$actions['CREATIVECLUBNEWSUBMIT']['url'];echo U($str,array('key'=>$actions['CREATIVECLUBNEWSUBMIT']['key']))?>'>提交</a>
					</form>
	...
	<script type="text/javascript" src="/Public/Home/js/Creative/Publish/index.js"></script>
