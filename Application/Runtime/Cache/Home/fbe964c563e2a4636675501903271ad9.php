...
<body class="page-body">
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" id="editInfoForm" name="editInfoForm" >
								...
								<div class="form-group" id="did" hidden="hidden">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="id" name="id" value="<?php echo ($studentInfo["id"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dstudent_ID">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="student_ID" name="student_ID" value="<?php echo ($studentInfo["student_id"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dname">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="name" name="name" value="<?php echo ($studentInfo["name"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dphone">
									...
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" class="form-control no-right-border" id="phone" name="phone" value="<?php echo ($studentInfo["phone"]); ?>">
										</div>
									</div>
								</div>
								...
								<div class="form-group" id="dcollege">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="college" name="college" value="<?php echo ($studentInfo["college"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dmajor">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="major" name="major" value="<?php echo ($studentInfo["major"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dclass">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="class" name="class" value="<?php echo ($studentInfo["class"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dIDcard">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="IDcard" name="IDcard"  value="<?php echo ($studentInfo["idcard"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dqq">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="qq" name="qq" value="<?php echo ($studentInfo["qq"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="demail">
									...
									<div class="col-sm-10">
										<input type="email" class="form-control" id="email" name="email" value="<?php echo ($studentInfo["email"]); ?>">
									</div>
								</div>
								...
								<div class="form-group" id="dwechat">
									...
									<div class="col-sm-10">
										<input type="wechat" class="form-control" id="wechat" name="wechat" value="<?php echo ($studentInfo["wechat"]); ?>">
									</div>
								</div>

								<?php if(isset($actions['USEREDITSUBMIT'])): ?><a type="button" id="btnSubmit" name="btnSubmit" class="btn btn-blue btn-single pull-right" _href="<?php $str = $Think.INDEX_PATH_NAME.$actions['USEREDITSUBMIT']['url'];echo U($str,array('key'=>$actions['USEREDITSUBMIT']['key']))?>">提交</a><?php endif; ?>
							</form>
	...
	<script type="text/javascript" src="/efan/Public/Home/js/User/User/edit.js"></script>
