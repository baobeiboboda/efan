...
<body class="page-body">
		...
		<div class="main-content">		
			...
			<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" enctype="multipart/form-data" id="newUserExcelForm" name="newUserExcelForm" >
								
								<div class="form-group" id="dexcel" name="dexcel">
									<label class="col-sm-2 control-label">Excel</label>
									
									<div class="col-sm-8">
										
										<div class="form-group">
											<input type="file" class="form-control" id="excel" name="excel" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"/>
										</div>
									</div>
								</div>
								<?php if(isset($actions['USERLEADINGINSUBMIT'])): ?><a class="btn btn-blue btn-single pull-right" id="btnSubmit" name="btnSubmit" _href="<?php $str = $Think.INDEX_PATH_NAME.$actions['USERLEADINGINSUBMIT']['url'];echo U($str,array('key'=>$actions['USERLEADINGINSUBMIT']['key']))?>">上传并导入数据</a><?php endif; ?>
	...
	<script type="text/javascript" src="/efan/Public/Home/js/User/User/leadingIn.js"></script>
