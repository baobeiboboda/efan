...
<body class="page-body">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" id="submitDailyForm">
								...
								<div class="form-group" id="dinfo">
									...
									<div class="col-sm-10">
										<textarea class="form-control autogrow" cols="5" id="info" name="info" placeholder="总结下今天你做了什么？"><?php echo ($message["info"]); ?></textarea>
									</div>
								</div>
								
								<?php if(isset($actions['TEAMDAILYSUBMIT'])): ?><a id="btnreturn" name="btnreturn" type="button" class="btn btn-blue btn-single pull-right" >返回</a>
									<a id="btnsubmit" name="btnsubmit" type="button" class="btn btn-blue btn-single pull-right" _href='<?php $str = $Think.INDEX_PATH_NAME.$actions['TEAMDAILYSUBMIT']['url'];echo U($str,array('key'=>$actions['TEAMDAILYSUBMIT']['key']))?>'>提交</a><?php endif; ?>
	...
	<script type="text/javascript" src="/efan/Public/Home/js/Daily/submit.js"></script>
