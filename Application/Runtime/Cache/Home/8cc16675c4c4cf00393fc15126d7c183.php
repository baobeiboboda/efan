...
<body class="page-body">	
		...
		<div class="main-content">		
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">移动应用开发创意管理</h3>
					...
					<div class="panel-options">
						...
						<?php if(isset($actions['USERNEW'])): ?><button class="btn btn-info btn-xs"  href="javascript:;" onclick="jQuery('#newUser').modal('show', {backdrop: 'static'});" class="btn btn-primary btn-single btn-sm">新建用户</button><?php endif; ?>
					...
					<table class="table table-striped table-bordered" id="user">
						...
						<tbody>
							<?php if(is_array($userList)): foreach($userList as $key=>$vo): ?><tr>
								...
								<td>
									<?php echo ($permision[$vo['permision']]['permision']); ?>
								</td>
								<td>
	...
	<script type="text/javascript" src="/efan/Public/Home/js/User/User/index.js"></script>
